        ...
        <div class="slider_image_product">
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    <img height="200" src="../assets/products/spersoo.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img height="200" src="../assets/products/capochino.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img height="200" src="../assets/products/amerecano.jpg" alt="">
                </div>
                <div class="swiper-slide">
                    <img height="200" src="../assets/products/hotchaklet.jpg" alt="">
                </div>
                <div class="swiper-slide">
    ...
    <div class="flex-row category">
        <div class="card food">
            ...
            <div class="card-title">
                <h5>قهوه اسپرسو</h5>
                <p>قهوه اسپرسو با کافئین بالا برای شما</p>
            </div>
            <p class="text-success card-text isAvailable">موجود</p>
            <p class=" food-price food-price">42،000 تومان</p>
        </div>
