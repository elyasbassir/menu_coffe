...
<div class="col-md-3 col-lg-2 px-0 position-fixed h-100 bg-white shadow-sm sidebar" id="sidebar">
    ...
    <div class="list-group rounded-0">
        ...
        ?>
        <a href="{{route('dashboard')}}" class="<?php echo ($name_route=='dashboard')? "active" : ""; ?> list-group-item list-group-item-action border-0 d-flex align-items-center">
            <span class="bi bi-border-all"></span>
            <span class="ml-2">داشبرد</span>
        </a>
        <a href="{{route('add_owner')}}" class="<?php echo ($name_route=='add_owner')? "active" : ""; ?> list-group-item list-group-item-action border-0 align-items-center">
